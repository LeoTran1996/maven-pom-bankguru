...
public class Customer_06_Delete_Account extends BaseTest {
	...
	@Test
	public void TC_01_Delete_Account_AccountNo_Canot_Be_Empty() {

		log.info("Delete_Account_AccountNo cannot be empty - Step 01: Input blank value to 'AccountNo' textbox");
		customerPage.sendKeyToTextboxByName(driver, "", "accountno");

		log.info("Delete_Account_AccountNo cannot be empty - Step 02: Press key TAB to 'CustomerID' textbox");
		customerPage.sendKeyboardToElement(driver, BasePageUI.DYNAMIC_TEXTBOX_BY_NAME, Keys.TAB, "accountno");

		log.info("Delete_Account_AccountNo cannot be empty - Step 03: Verify warning message is displayed with 'Customer ID is required'");
		verifyEquals(customerPage.getWarningMessageByID(driver, "2"), "Account Number must not be blank");

	}

	@Test
	public void TC_02_Delete_Account_AccountNo_Must_Be_Numeric() {

		log.info("Delete_Account_AccountNo cannot be numeric - Step 01:  Input numeric to 'AccountNo' textbox with value: 'anhtran123'");
		customerPage.sendKeyToTextboxByName(driver, "anhtran123", "accountno");

		log.info("Delete_Account_AccountNo cannot be numeric - Step 02: Verify warning message is displayed with 'Characters are not allowed'");
		verifyEquals(customerPage.getWarningMessageByID(driver, "2"), "Characters are not allowed");
	}

	@Test
	public void TC_03_Delete_Account_AccountNo_Can_Not_Have_Special_Characters() {

		log.info("Delete_Account_AccountNo cannot have special charater - Step 01:  Input to 'AccountNo' textbox with value: '123@#'");
	...
	public void TC_04_Delete_Account_AccountNo_Can_Not_Have_First_Character_As_Blank() {
		...
		log.info("Delete_Account_AccountNo cannot have first character as blank space - Step 01:  Input to 'AccountNo' textbox with value: ' 123456'");
		customerPage.sendKeyToTextboxByName(driver, " ", "accountno");
	...
	public void TC_05_Delete_Account_AccountNo_Can_Not_Have_Blank_Space() {
		...
		log.info("Delete_Account_AccountNo cannot have blank space - Step 01:  Input to 'AccountNo' textbox with value: '123 34'");
		customerPage.sendKeyToTextboxByName(driver, "123 34", "accountno");
