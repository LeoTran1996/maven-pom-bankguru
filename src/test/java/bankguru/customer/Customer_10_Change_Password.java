...
public class Customer_10_Change_Password extends BaseTest {
	...
	public void TC_06_Change_Password_Confirm_Password_Must_Be_Matched() {
		...
		log.info("Change_Password_Confirm_Password must be matched' - Step 01:  Input to 'New Password' textbox with value: 'anhtran'");
		...
		log.info("Change_Password_Confirm_Password must be matched - Step 02: Verify warning message is displayed with 'Passwords do not Match'");
